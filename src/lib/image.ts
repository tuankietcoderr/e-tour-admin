import { BASE_IMAGES_URL } from "@/constants/server";
...
const IMAGE_PLACEHOLDER: string =
  "https://i.ibb.co/Sv1Wrm7/Screenshot-2023-06-11-150019-min.png";
...
export function avatarStorage(id: string) {
  if (id) {
    if (id.includes("file://") || id.includes("blob") || id.includes("http"))
      return id;
  }
